    ...
    <div class="row">
            ...
            <div class="card bg-success text-white rounded-4 shadow">
                <div class="card-body d-flex gap-2">
                    <div class="rounded-circle bg-white p-2">
                        <svg fill="#198754" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="40"
                            height="40">
        ...
        <div class="col-lg-6 mb-3">
            <div class="card bg-danger text-white rounded-4 shadow">
                <div class="card-body d-flex gap-2">
                    <div class="rounded-circle bg-white p-2">
                        <svg fill="#F80B0B" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="40"
                            height="40">
                            <g id="SVGRepo_bgCarrier" stroke-width="1"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
            ...
            <div class="row justify-content-start justify-content-lg-between p-0 m-0" style=" margin-top:20px;">
                <div class="p-0" style="width: fit-content;">
                    <button class="btn btn-info mb-2" data-bs-toggle="modal" data-bs-target="#form-create-petikemas">
                        <div class="d-flex gap-1" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div class="p-0" style="width: fit-content;">
                    <form class="d-flex m-0 p-0" role="search" id="searchForm" style="width: 21rem;">
                        <input class="form-control  shadow" type="search" placeholder="Search Something"
                            aria-label="Search" style="border-radius: 10px 0px 0px 10px;" id="searchInput">
                        <button class="btn btn-secondary shadow" type="submit"
                            style="border-radius: 0px 10px 10px 0px;"><i
                                class="fa-solid fa-magnifying-glass text-white" style="font-size:1.5rem"></i></button>
                    </form>
                </div>
            </div>
                        ...
                        $.each(response.Data, function(index, item) {
                            $('#table_petikemas tbody').append(
                                ...
                                '</td><td> <div class="' + (item.status_kondisi === 'damage' ? 'bg-danger' : 
                                                    item.status_kondisi === 'available' ? 'bg-success' : '') + ' fw-semibold fs-5 p-1 rounded-2 text-white " style="display: inline-block;">' + item.status_kondisi +
                                '</div></td><td><div class="fw-semibold fs-5 bg-success p-1 rounded-2 text-white" style="display: inline-block;">' + item.status_ketersediaan +
                                '</div></td><td><div class="fw-semibold fs-5 bg-warning p-1 rounded-2 text-white">' + item.lokasi +
                                '</div></td><td><div class="btn-group gap-2"><a class="btn btn-info text-white p-0 rounded-3" style="width: 2.5rem; height: 2.2rem;" href="/peti-kemas/' +
                                item.id +
