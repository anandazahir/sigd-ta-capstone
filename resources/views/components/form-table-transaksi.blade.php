                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3 form-group">
                                ...
                                <input type="number" class="form-control" id="jumlah peti kemas"
                                    placeholder="Jumlah Peti Kemas" name="jumlah peti kemas" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 mb-3 form-group">
                                <label for="no. do" class="form-label">No. DO</label>
                                <input type="number" class="form-control" id="no. do" placeholder="No. DO"
                                    name="no. do" required>
