        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                ...
                <svg fill="#f09259 " viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="3.7rem" height="3.7rem">
                        ...
                        <!-- Pengkondisian sementara biar tetap nilainya available kalo null -->
                        @if($data && $data->status_kondisi)
                            {{$data->status_kondisi}}
                        @else
                            available
                        @endif
                ...
                <div class="card shadow rounded-4 bg-white">
                    <div class="card-body">
                        ...
                        <h5 class="fw-semibold fs-5 text-black" style="margin-left:65px">
                            ...
                            <!-- Pengkondisian sementara juga biar enak diliat data peti kemasnya wkwk -->
                        @if($data && $data->tanggal_keluar)
                            {{$data->tanggal_keluar}}
                        @else
                        05 Desember 2022
                        @endif 
        ...
        <div class="row">
            <div class="col-lg-6 mb-3">
                ...
                <svg fill="#f09259 " viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="3.7rem" height="3.7rem">
                        ...
                        <!-- Pengkondisian sementara -->
                        @if($data && $data->status_ketersediaan)
